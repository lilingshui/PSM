...
typedef CXTPMarkupObject* (*PFNCONVERTFROM)(CXTPMarkupContext* pContext, CXTPMarkupObject* pObject);
...
public:
	...
	virtual CXTPMarkupObject* ConvertFrom(CXTPMarkupObject* pObject) const;
