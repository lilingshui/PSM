...
//-----------------------------------------------------------------------
// Summary:
//     Represent the Header/Footer rows devider style.
//-----------------------------------------------------------------------
...
public:
	...
	//      for Office2007 column style.
	// Parameters:
	//      clrTheme - A COLORREF value representing the custom theme base color.
	...
	//     pMetrics  - Metrics of the item
	//-----------------------------------------------------------------------
	virtual void DrawItemControl(XTP_REPORTRECORDITEM_DRAWARGS* pDrawArgs, CXTPReportRecordItemControl* pControl, CRect& rcItem);
	...
	// See Also: SetDrawGridForEmptySpace
	//-----------------------------------------------------------------------
	...
	// Returns:
	//     TRUE if grid fills empty space after the body rows, FALSE - otherwise (default).
	// See Also: IsDrawGridForEmptySpace
	//-----------------------------------------------------------------------
...
protected:
	...
	//-----------------------------------------------------------------------
	virtual void DrawColumnBackground(CDC* pDC, CXTPReportColumn* pColumn, CRect rcColumn, BOOL& bColumnPressed, CXTPReportHeader* pHeader = NULL);
protected:
...
public:
	...
	//-----------------------------------------------------------------------
	void DrawFixedRowsDivider(CDC* pDC, const CRect& rc, CXTPReportControl* pControl, BOOL bHeaderRows, BOOL bVScrollBarVisible = TRUE);
