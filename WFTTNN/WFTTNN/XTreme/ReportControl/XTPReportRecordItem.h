...
public:
	...
	//-----------------------------------------------------------------------
	virtual BOOL OnEditChanging(XTP_REPORTRECORDITEM_ARGS* pItemArgs, CString& rstrNewText) { UNREFERENCED_PARAMETER(pItemArgs); UNREFERENCED_PARAMETER(rstrNewText); return TRUE;}
...
AFX_INLINE int CXTPReportRecordItem::SetAlignment(int nAlignment) {
	int nOld = m_Alignment; m_Alignment = (XTPReportColumnIconAlignment)nAlignment; return nOld;
}
